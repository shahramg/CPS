...
for j=1:numFiles
    ...
    disp(outputT);
    [vertexList, faceList, minW, maxW, minH, maxH, minD, maxD] = readPLYfile(filePath);
    ptCldArray{j} = CloudPoint(j,filePath,vertexList,faceList,minW,maxW,minH,maxH,minD,maxD);
end
end
